...
import com.github.s0nerik.betterknife.annotations.OnItemSelected
import com.github.s0nerik.betterknife.annotations.OnPageChanged
import com.github.s0nerik.betterknife.annotations.OnTextChanged
 ...
 */
@CompileStatic
public class BetterKnife {

    public static Handler mHandler = new Handler(Looper.getMainLooper());

    public static final String TAG = "BetterKnife";
    ...
    public static boolean setOnClick(View v, Object target, String methodName) {
        v.setOnClickListener(new View.OnClickListener() {
            ...
            void onClick(View view) {
                Method method = null;
                if ((method = BetterKnife.searchMethod(target, methodName, [View.class])) != null) {
                    method.invoke(target, view);
                }
                else if ((method = BetterKnife.searchMethod(target, methodName, [])) != null) {
    ...
    public static void setOnItemClick(AbsListView v, Object target, String methodName) {
        v.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Method method = null;
                if ((method = BetterKnife.searchMethod(target, methodName, [int,
                                                                           AdapterView.class]))
                        != null) {
                    method.invoke(target, [i, adapterView].toArray());
                }
                else if ((method = BetterKnife.searchMethod(target, methodName, [int,
                                                                                AdapterView
                                                                                        .class,
                                                                                View.class])) !=
                        null) {
                ...
                else if ((method = BetterKnife.searchMethod(target, methodName, [int])) != null) {
        ...
        v.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                if (OnItemSelected.Method.ITEM_SELECTED == methodEnum) {
                    ...
                    else if ((method = BetterKnife.searchMethod(target, methodName,
                            [int])) != null) {
                        method.invoke(target, i);
                    }
                    else {
            ...
            void onNothingSelected(AdapterView<?> adapterView) {
                if (OnItemSelected.Method.NOTHING_SELECTED == methodEnum) {
                    Method method = null;
                    if ((method = BetterKnife.searchMethod(target, methodName,
        ...
        v.setOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            void onPageScrolled(int position, float offset, int offsetInPixels) {
                if (OnPageChanged.Method.PAGE_SCROLLED == methodEnum) {
                    Method method = null
                    if ((method = BetterKnife.searchMethod(target, methodName, [int])) != null) {
                        method.invoke(target, [position].toArray());
                    }
                    else if ((method = BetterKnife.searchMethod(target, methodName, [int, float,
                                                                                    int])) !=
                            null) {
        ...
        v.addTextChangedListener(new TextWatcher() {
            ...
            void onTextChanged(CharSequence charSequence, int start, int before, int count) {
                if (OnTextChanged.Method.ON_TEXT_CHANGED == methodEnum) {
                    ...
                    else if ((method = BetterKnife.searchMethod(target, methodName, [View.class,
                                                                                    CharSequence
                                                                                            .class])) != null) {
                        method.invoke(target, [v, charSequence].toArray());
                    }
    ...
    public static void setOnChecked(CompoundButton v, Object target, String methodName) {
        v.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                Method method = null;
                if ((method = BetterKnife.searchMethod(target, methodName, [CompoundButton.class,
                                                                           boolean.class])) !=
                        null) {
    ...
    public static void setOnFocusChanged(View v, Object target, String methodName) {
        v.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            void onFocusChange(View view, boolean b) {
                Method method = null;
                if ((method = BetterKnife.searchMethod(target, methodName, [View,
                                                                           boolean.class])) !=
                        null) {
    ...
    public static void setOnEditorAction(TextView v, Object target, String methodName) {
        v.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            boolean onEditorAction(TextView textView, int actionId, KeyEvent keyEvent) {
                Method method = null;
                if ((method = BetterKnife.searchMethod(target, methodName, [TextView.class,
                                                                           KeyEvent.class])) !=
                        null) {
    ...
    public static void runOnBackground(Object target, String methodName, Object... parameters) {
        ...
        if ((method = BetterKnife.searchMethod(target, methodName, parameterClasses)) != null) {
