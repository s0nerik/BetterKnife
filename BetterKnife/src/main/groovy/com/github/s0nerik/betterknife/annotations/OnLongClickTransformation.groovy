...
public class OnLongClickTransformation implements ASTTransformation, Opcodes {
    ...
    void visit(ASTNode[] astNodes, SourceUnit sourceUnit) {
        ...
        if (annotation.members.size() > 0) {
            ...
            throw new Exception("OnLongClick must have an id");
        }

        if (annotatedMethod.getReturnType().name != "boolean" && annotatedMethod.getReturnType()
                .name != "java.lang.Boolean") {
            throw new Exception("OnLongClick must return a boolean value");
        }
    ...
    private Statement createInjectStatement(String id, MethodNode method, MethodNode injectMethod) {
        ...
        BlockStatement statement =
                block(
                        ...
                        stmt(callX(ClassHelper.make(BetterKnife), "setOnLongClick",
