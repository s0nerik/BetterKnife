package com.github.s0nerik.betterknife.dsl
...
import com.github.s0nerik.betterknife.dsl.components.Form
import com.github.s0nerik.betterknife.dsl.components.GArrayAdapter
import com.github.s0nerik.betterknife.dsl.components.GAsyncTask
import com.github.s0nerik.betterknife.dsl.components.ObjectPropertyResolver
...
class AndroidDSL {
    ...
    static <T, S> S async(S context,
                          @ClosureParams(value = FromString, options = ['S', 'S,com.github.s0nerik.betterknife.dsl.components.GAsyncTask'])
                                  Closure<T> task) {
